...
char* g_argv[] =
{
  reinterpret_cast<char*>(const_cast<char*>("./TopicEchoSnackBar_TEST")),
};
...
/////////////////////////////////////////////////
TEST(TopicEchoSnackBarTest, IGN_UTILS_TEST_DISABLED_ON_WIN32(Load))
{
  ...
  // Load plugin
  EXPECT_TRUE(app.LoadPlugin("TopicEchoSnackBar"));
  ...
  EXPECT_EQ(plugin->Title(), "Topic Echo SnackBar");
...
/////////////////////////////////////////////////
TEST(TopicEchoTest, IGN_UTILS_TEST_DISABLED_ON_WIN32(Echo))
{
  common::Console::SetVerbosity(4);
  ...
  // Get plugin
  auto plugins = win->findChildren<plugins::TopicEchoSnackBar *>();
  EXPECT_EQ(plugins.size(), 1);
