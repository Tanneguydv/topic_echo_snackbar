...
#ifndef GZ_GUI_PLUGINS_TOPICECHOSNACKBAR_HH_
#define GZ_GUI_PLUGINS_TOPICECHOSNACKBAR_HH_
...
#ifndef _WIN32
#  define TopicEchoSnackBar_EXPORTS_API
#else
#  if (defined(TopicEchoSnackBar_EXPORTS))
#    define TopicEchoSnackBar_EXPORTS_API __declspec(dllexport)
#  else
#    define TopicEchoSnackBar_EXPORTS_API __declspec(dllimport)
#  endif
#endif
...
namespace plugins
{
  ...
  class TopicEchoSnackBar_EXPORTS_API TopicEchoSnackBar : public Plugin
  {
    Q_OBJECT
    ...
    /// \brief Constructor
    public: TopicEchoSnackBar();
    

    /// \brief Destructor
    public: virtual ~TopicEchoSnackBar();
    ...
    private: std::unique_ptr<TopicEchoSnackBarPrivate> dataPtr;
  };
}
}
}
